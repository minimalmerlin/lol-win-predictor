...
class MLEngine:
    ...
    async def load_all_models(self):
        ...
        try:
            ...
            self.champion_predictor.load_model('./models/champion_predictor.pkl')
        ...
        try:
            ...
            logger.info(f"✓ Champion Stats loaded ({len(self.champion_stats)} champions)")
        except Exception as e:
        ...
        try:
            ...
            logger.info(f"✓ Item Builds loaded ({len(self.item_builds)} champions)")
        except Exception as e:
            logger.error(f"❌ Failed to load Item Builds: {e}")

        # Intelligent Item Recommender
        try:
            self.item_recommender = IntelligentItemRecommender(data_dir='./data/champion_data')
        ...
        try:
            ...
            logger.info(f"✓ Best Teammates loaded ({len(self.best_teammates)} champions)")
        except Exception as e:
        ...
        try:
            self.build_generator = DynamicBuildGenerator(data_dir='./data/champion_data')
